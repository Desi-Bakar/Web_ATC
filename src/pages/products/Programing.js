        ...
        <div className="container">
          <div style={gridStyle}>
            ...
            <div style={cardStyle}>
              <img
                src="/img/11.png"
                alt="Java Programming Basic with Netbeans"
                style={imageStyle}
              />
              <div style={contentStyle}>
                <h1 className="title" style={{ marginBottom: "1rem" }}>
                ...
                <p>
                  <strong>Materi:</strong> Pengenalan Java & Editor: Elemen Dasar (Variabel & Tipe Data), Коnsер OOP, Operator, Fungsi, Kondisi IF, Kondisi Switch-Case: Perulangan Array, Latihan, Studi Kasus.
                </p>
              </div>
            </div>
